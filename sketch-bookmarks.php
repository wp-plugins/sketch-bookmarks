...
Version: 1.0
Plugin URI: http://www.sitesketch101.com/sketch-bookmarks
...
function add_me($content) {
	...
	$sketch_images_folder = get_settings('home') . '/wp-content/plugins/sketch-bookmarks/images/';
	
	if (!is_feed() && !is_page()) {
	
		$content .= "\n\n" . '<!--Being Sketched Bookmarks-->' . "\n" . 
...
function print_sketch_form() {
  ...
  <tr>
    ...
    <br /><a href="http://www.sitesketch101.com"><img src="<?php echo get_settings('home') . '/wp-content/plugins/sketch-bookmarks/images/'; ?>468x60-B.jpg" /></a>
