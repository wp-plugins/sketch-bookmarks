...
function add_me($content) {
	...
	$sketch_images_folder = get_option('wpurl') . '/wp-content/plugins/sketch-bookmarks/images/';
...
function print_sketch_form() {
  ...
  <tr>
    ...
    <br /><a href="http://www.sitesketch101.com"><img src="<?php echo get_option('wpurl') . '/wp-content/plugins/sketch-bookmarks/images/'; ?>468x60-B.jpg" /></a>
